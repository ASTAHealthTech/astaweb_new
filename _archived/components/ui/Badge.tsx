...
const tones: Record<Tone, string> = {
  neutral: "bg-bg-alt text-fg-muted ring-1 ring-line dark:bg-white/[0.06] dark:text-frost-muted dark:ring-white/[0.08]",
  brand: "bg-brand-50 text-brand-600 ring-1 ring-brand-100 dark:bg-brand-500/15 dark:text-brand-200 dark:ring-brand-400/20",
  success: "bg-brand-50 text-brand-700 ring-1 ring-brand-100 dark:bg-brand-500/12 dark:text-brand-200 dark:ring-brand-400/20",
  live: "bg-brand-50 text-brand-700 ring-1 ring-brand-100 dark:bg-brand-500/12 dark:text-brand-200 dark:ring-brand-400/20",
