...
export function Card({
  ...
  return (
    <div
      className={cn(
        "group relative flex flex-col rounded-xl border border-border bg-white p-6 shadow-xs",
        "dark:border-night-edge dark:bg-night-panel dark:shadow-glass-sm",
  ...
  return (
    <p
      className={cn(
        ...
        dark ? "text-frost-muted" : "text-fg-muted",
        className
      )}
    >
      {children}
