  ...
  return (
    <div ref={wrapRef} className="relative">
      <video
        ...
        className="mx-auto max-h-[520px] w-auto cursor-pointer object-contain"
      />
      {!interacted && (
  ...
  return (
    <section className="py-section">
      <Container>
        ...
        <div className="mt-16 grid grid-cols-1 gap-x-8 gap-y-16 lg:grid-cols-12">
          ...
          <Reveal className="lg:col-span-7">
            ...
            <Bezel
              ...
              timestamp={c.mediaLabel.toLowerCase()}
        ...
        {/* REAL ASSESSMENT FIGURE — recorded from the ASTA clinical workspace */}
